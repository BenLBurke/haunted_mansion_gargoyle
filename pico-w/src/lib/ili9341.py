...
Vendored verbatim from rdagger/micropython-ili9341 (MIT licensed):
https://github.com/rdagger/micropython-ili9341/blob/master/ili9341.py

gargoyle's own display.py wraps this in a small adapter (ILI9341Screen)
that reuses only the low-level write_cmd/write_data/block primitives here
-- the higher-level draw_* methods below aren't used by the app, but are
left in unmodified in case they're useful for anyone extending this.
"""
