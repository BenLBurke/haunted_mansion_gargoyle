# Vendored verbatim from micropython-lib (python-ecosys/requests/requests/__init__.py),
# MIT licensed. https://github.com/micropython/micropython-lib
#
# Copied in rather than installed via `mip` so the gargoyle works fully offline
# once it's set up -- no network access needed to (re)provision dependencies.
